...
export default function Home() {
  ...
  const handleCategoryDelete=(container)=>{
    setTodos((prev) => {
      const newData =  {...prev};
      delete newData[container];
      return newData;
    });
    handleClose();
  }
  ...
  return (
    ...
    >
      ...
      <div
        ...
        // className="no-scroll"
        className={(Object.keys(todos).length > 3) ? "custom-scrollbar" : "no-scroll"}
      >
              ...
              <div>
                ...
                >
                  <div style={{ padding: "18px" }}>
                    ...
                    /> */}
                    <button onClick={()=>handleCategoryDelete(container)}>Delete Category</button>
                  </div>
                </Menu>
                <IconButton
                  size="small"
